...
public class PotentialYieldLegumes extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    EditText tgw, population, grainAmount, podAmount;
    TextView result;
    DecimalFormat df;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_potential_yield_legumes);
        result = findViewById(R.id.calc3result);
        result.setText("–");
        tgw = findViewById(R.id.calc3tgw);
        population = findViewById(R.id.calc3population);
        grainAmount = findViewById(R.id.calc3grain_amount);
        podAmount = findViewById(R.id.calc3pod_amount);
        ...
        podAmount.addTextChangedListener(textWatcher);
        ...
        // Create the spinner.
        Spinner spinner = findViewById(R.id.calc3result_spinner);
        if (spinner != null) {
    ...
    public void calculationPerform() {
        ...
        String podAmoundStr = podAmount.getText().toString();
        if (!tgwStr.isEmpty() && !populationStr.isEmpty() && !grainAmountStr.isEmpty() && !podAmoundStr.isEmpty()) {
            try {
                ...
                double podAmountDb = Double.parseDouble(podAmoundStr);
                double resultDb = Calculator.potentialYieldLegumes(podAmountDb, tgwDb, populationDb, grainAmountDb);
